...
# Загрузка пользователей (менеджеров) - частота из env (в минутах)
# По умолчанию каждый час (60 минут)
# Рекомендуется: 30-60 минут для частого обновления данных о менеджерах
# Для отключения установите ETL_USERS_INTERVAL=0
ETL_USERS_INTERVAL=60
